...
var Template =
{
	...
	parse: function(rawData)
	{
        ...
        var parsedBlocks = {};
        var foundBlock = null;
        var resultBlock, rawBlock, parsedBlock, tokenName;
        ...
        do
        {
            ...
            {       
                ...
                { 
                    ...
                    {   
                        rawBlock[i] && parsedBlock.push("'"+rawBlock[i].replace(/'/g, "\\'")+"'");        
                    }
                }
	...
	{
		this.debug && console.time('Compile');
        ...
        this.debug && console.timeEnd('Compile');	
	},
